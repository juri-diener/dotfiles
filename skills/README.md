...
| arrange | pbakaus/impeccable |
| audit | pbakaus/impeccable |
| bolder | pbakaus/impeccable |
| brainstorming | obra/superpowers |
| clarify | pbakaus/impeccable |
| colorize | pbakaus/impeccable |
...
Installed/updated with the `skills` CLI (`npx skills add -g`). See `.skill-lock.json` for full provenance.
